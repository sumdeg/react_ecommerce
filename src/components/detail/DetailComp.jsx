...
const DetailComp = ({productDetail}) => {
  ...
  return (
    <div className='flex gap-10 my-10 p-20'>
        <img className='w-[400px] h-[400px] object-contain' src={productDetail?.image} alt="" />
        <div className=''>
            ...
            <div onClick={addBasket} className=' my-4 border w-[200px] text-2xl bg-gray-200 cursor-pointer rounded-md h-16 flex items-center justify-center'>Sepete Ekle</div>
        </div>
    </div>
  )
}
